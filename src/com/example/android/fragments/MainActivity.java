...
public class MainActivity extends FragmentActivity implements HeadlinesFragment.OnHeadlineSelectedListener {
  ...
  public void onArticleSelected(int position) {
    ...
    if (articleFrag != null) {
       ...
       *
       * first param is for the next fragment's anim
       * second param is for the current fragment's anim
       * third param is for the back stack fragment's anim
       * fourth is for the fragment's anim that user presses back button on
       */
  ...
  public void onBackPressed() {
    ...
    if (mCurrentArticle != -1) {
      setTitle("Main Activity Title: " + mCurrentArticle);
    }
  }
